...
// this solution uses the native javascript sort with a callbackfunction passed it, which doesn't work because the matching occurences get sorted as well.
...
//   const wordOccur = []
//   for(word in hash){
//     wordOccur.push([word,hash[word]])
//   }
//   // loop through array
//   return wordOccur.sort((a,b)=>{
//     if(b[1]===a[1]){
//       return
//     }
//     else return b[1]-a[1]}).map(x=>{
//     return [x[0],x[1]+'']
//   })
// }
